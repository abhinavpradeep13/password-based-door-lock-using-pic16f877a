...
SOURCEFILES_QUOTED_IF_SPACED=newfile5.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/newfile5.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/newfile5.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/newfile5.p1

# Source Files
SOURCEFILES=newfile5.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/newfile5.p1: newfile5.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/newfile5.p1.d 
	@${RM} ${OBJECTDIR}/newfile5.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/newfile5.p1 newfile5.c 
	@-${MV} ${OBJECTDIR}/newfile5.d ${OBJECTDIR}/newfile5.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/newfile5.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
